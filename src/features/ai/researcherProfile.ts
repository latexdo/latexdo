...
const CODENAME_ADJECTIVES = [
  "stellar", "quantum", "cosmic", "lunar", "nebular", "photon", "crimson",
  "auroral", "tidal", "prismatic", "gravity", "solar", "arctic", "obsidian",
  "electric", "verdant", "sable", "radiant", "spectral", "kinetic",
];
const CODENAME_NOUNS = [
  "quokka", "axolotl", "narwhal", "pangolin", "lynx", "heron", "manta",
  "ibex", "falcon", "otter", "tapir", "comet", "quasar", "lantern",
  "meridian", "cipher", "atlas", "orchid", "beacon", "harbor",
];
